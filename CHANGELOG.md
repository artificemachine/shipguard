...
- 2026-08-17: chore(release) — bump to v0.5.4 (shellcheck json1 parsing fix). Note: 0.5.3 is already used by fix/py-007-sql-keyword-precision, a separate branch off the same main; both will need a rebase before whichever merges second.
